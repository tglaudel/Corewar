...
exec("diff test1 test2");
echo "-------- if nothing here diff OK --------\n";
echo "-------- diff on ./corewar helltrain -v 31 -d 6000 --------\n";
...
exec("diff test1 test2");
echo "-------- if nothing here diff OK --------\n";
echo "-------- diff on ./corewar helltrain bee_gees balzac fluttershy -v 31 --------\n";
exec("./corewar ressources/champions/examples/helltrain.cor ressources/champions/examples/bee_gees.cor ressources/champions/examples/balzac.cor ressources/champions/examples/fluttershy.cor -v 31 > test1");
exec("./ressources/corewar ressources/champions/examples/helltrain.cor ressources/champions/examples/bee_gees.cor ressources/champions/examples/balzac.cor ressources/champions/examples/fluttershy.cor -v 31 > test2");
exec("diff test1 test2");
